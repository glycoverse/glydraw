...
This outlines how to propose a change to glydraw. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("glycoverse/glydraw", fork = TRUE)`.
...
Please note that the glydraw project is released with a [Contributor
Code of
Conduct](https://glycoverse.github.io/glydraw/dev/CODE_OF_CONDUCT.md).
