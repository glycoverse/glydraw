...
* `draw_cartoon()` and all glycan-grob-based interfaces now render unusual absolute configurations and furanose residues supported by glyrepr and glyparse, with centered labels such as `D`, `f`, and `Df` inside their natural SNFG glyphs.
